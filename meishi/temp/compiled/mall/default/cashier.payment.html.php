...
<div class="content">
    ...
    <div class="module_common">
        <div class="step_main">
            <div class="clue_on"><h4>order_created</h4><p>order_created_desc</p></div>
            <div class="order_information">
                ...
                <p><a href="<?php echo url('app=buyer_order'); ?>" target="_blank">member_view_order</a></p>
            </div>

            <div class="buy">
                <h3><b class="ico">select_payment</b></h3>
                <?php if ($this->_var['payments']['online']): ?>
                <dl class="defray">
                    <dt>online_payment</dt>
...
?>
            ...
            <div class="make_sure">
                <p>
                    <a href="javascript:$('#goto_pay').submit();" class="btn">confirm_pay</a>
                </p>
            </div>
            <!--<div class="remark">
