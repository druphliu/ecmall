<?php echo $this->fetch('wechat.header.html'); ?>
...
<div class="add">
    <div id="warning"></div>
    <form method="post" action="index.php?app=wechat&act=<?php echo $this->_var['act']; ?>&addr_id=<?php echo $this->_var['address']['addr_id']; ?>" id="address_form">
    <ul>
        <li>
            <h3>收货人姓名: </h3>
    ...
    <div class="submit">
        ...
        <input type="submit" class="btn" value="<?php if ($this->_var['address']['addr_id']): ?>编辑地址<?php else: ?>新增地址<?php endif; ?>" /></div>
    </form>
</div>
</div>
