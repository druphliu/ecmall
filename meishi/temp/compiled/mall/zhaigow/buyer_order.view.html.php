...
?>
                    ...
                    <div class="transportation">优惠打折&nbsp;:&nbsp;<span><?php echo price_format($this->_var['order']['discount']); ?></span>总价&nbsp;:&nbsp;<b><?php echo price_format($this->_var['order']['order_amount']); ?></b></div>
                    <ul class="order_detail_list">
                       <?php if ($this->_var['order']['payment_code']): ?>
                        ...
                        <li>确认时间&nbsp;:&nbsp;<?php echo local_date("Y-m-d H:i:s",$this->_var['order']['pay_time']); ?></li>
                        <?php endif; ?>
