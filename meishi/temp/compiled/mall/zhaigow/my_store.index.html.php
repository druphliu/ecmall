            ...
            <form method="post" enctype="multipart/form-data" id="my_store_form" >
                    ...
                    <div class="setup info shop">
                        ...
                        <table style="width: 100%">
                            ...
                            <?php endif; ?>
                            <tr>
                                <th class="width2">代理商名称:</th>
                                <td>
                                    <p class="td_block"><input id="store_name" type="text" class="text width_normal" name="store_name" value="<?php echo htmlspecialchars($this->_var['store']['store_name']); ?>"/><label class="field_notice">代理商名称</label></p>
                                    <b class="padding1">*</b>
                                </td>
                            </tr>
                            <tr>
...
?>
                                    ...
                                    <label generated="true" class="seller_area_notice"></label>
