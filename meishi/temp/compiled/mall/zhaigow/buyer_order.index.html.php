...
?>
                <div class="order_form">
                    <h2>
                        ...
                        <p class="name"><a target="_blank" href="<?php echo url('app=message&act=send&to_id=' . $this->_var['order']['seller_id']. ''); ?>" class="email"></a></p>
...
?>
                    <div class="con">
                        <p class="ware_pic"><img src="<?php echo $this->_var['goods']['goods_image']; ?>" width="50" height="50"  /></p>
                        <p class="ware_text"><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?><br /><span class="attr"><?php echo htmlspecialchars($this->_var['goods']['specification']); ?></span></p>
