...
//]]>
    ...
    <div class="module_common">
        <h2><b class="set_up_shop" title="SHOP REGISTRATION我要成为代理商"></b></h2>
        <div class="wrap">
            <div class="wrap_child">
                ...
                <div class="module_new_shop">
                    ...
                    <div class="chart">
                        <div class="pos_x1 bg_a1" title="1. 选择代理商类型"></div>
                        <div class="pos_x2 bg_b2" title="2. 填写代理商信息"></div>
                    ...
                    <div class="info_shop">
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan="2"><p class="padding4"><input type="checkbox"<?php if ($this->_var['store']): ?> checked="checked"<?php endif; ?> name="notice" value="1" id="warning" /> <label for="warning">我已认真阅读并完全同意<a href="index.php?app=article&act=system&code=setup_store" target="_blank">代理商协议</a>中的所有条款</label></p></td>
                                <td></td>
                            </tr>
                            <tr>
