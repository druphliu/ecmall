...
<div class="content">
    ...
    <div id="right">
        ...
        <div class="wrap">
            <?php if (! $this->_var['addresses']): ?><div class="eject_btn" title="新增地址"><b class="ico1" ectype="dialog" dialog_title="新增地址" dialog_id="my_address_add" dialog_width="600" uri="index.php?app=my_address&act=add">新增地址</b></div><?php endif; ?>
